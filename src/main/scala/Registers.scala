...
/** This module is already done. Have one on me
  *
  * When a write and read conflicts this might result in stale data. This caveat
  * must be handled using a bypass.
  */
class Registers() extends MultiIOModule {
  ...
  /** Mem creates asynchronous read, synchronous write. In other words, reading
    * is combinatory.
    */
